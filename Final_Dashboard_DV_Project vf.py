...
fig_map.update_layout(
    title=dict(text='Daily Oil Production',x=0.5,font=dict(family='Arial', size=18, color='black')),
...
fig_bubble.update_layout(
    title=dict(text='Renewable Energy Capacity, GDP per capita and Oil Capacity',
               x=0.5,font=dict(family='Arial', size=18, color='black')),
...
def plot(event, source):
    ...
    layout_1 = dict(title=dict(
        text='Oil Price',x=0.5, font=dict(family='Arial', size=18, color='black')
    ),
    ...
    fig_pie.update_layout(
        title=dict(text='Energy Consumption by Industry Sector',x=0.5, font=dict(family='Arial', size=18, color='black')),
...
def plots(country, year_treemap):
    ...
    fig_treemap.update_layout(
        title=dict(text='Country Zoom-in - Energy Consumption by Source (EJ)',x=0.5,font=dict(family='Arial', size=18, color='black')),
